...
public class NumberOfLinesToWriteString {
    public static void main(String[] args) {
        ...
        int[] widths2=new int[]{10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10};
        String s2="abcdefghijklmnopqrstuvwxyz";
        System.out.println(Arrays.toString(solution.numberOfLines(widths2,s2)));
    }
    ...
    class Solution {
        public int[] numberOfLines(int[] widths, String s) {
            ...
            for (int i = 0; i < s.length(); i++) {
                countWidths+=widths[s.charAt(i)-97];
                if (countWidths>100){
                    i--;
                    countRows++;
                    countWidths=0;
            ...
            return new int[]{countRows,countWidths};
        }
    }
